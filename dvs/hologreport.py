...
def load_predicted(freqMHz, beacon_pol, DISHPARAMS, el_deg=45, band="Ku", root="../models/beam-patterns/ska", applypointing='perfeed', gridsize=512, **kwargs):
    ...
    # Conjugation changes the direction of travel (+z); invert the sign of H-pol (only feedcombine?) to maintain IEEE definition of RCP.
...
def calculate_ant_eff(mss, rrs=None, ieee=True, fspec_MHz=None, return_ids=False):
