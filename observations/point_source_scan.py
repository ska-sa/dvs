...
styles = {
    ...
    'skaku-wide': dict(dump_rate=1.0, num_scans=20, scan_duration=40, scan_extent=2.6, scan_spacing=0.1),
    'skaku-el': dict(dump_rate=1.0, num_scans=9, scan_duration=60, scan_extent=0.5, scan_spacing=0.5/8),
    'skaku': dict(dump_rate=1.0, num_scans=9, scan_duration=8, scan_extent=0.36, scan_spacing=0.36/8), # APH on 11/2021 - drives support 0.045deg/sec
}
