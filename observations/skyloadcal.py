...
with verify_and_connect(opts) as kat:
    ...
    with start_session(kat, **vars(opts)) as session:
        ...
        while once or time.time() < start_time + opts.max_duration:
            ...
            antenna = katpoint.Antenna('ant1, -30:43:17.3, 21:24:38.5, 1038.0, 12.0, 18.4 -8.7 0.0, '
                                       '-0:05:30.6 0 -0:00:03.3 0:02:14.2 0:00:01.6 -0:01:30.6 0:08:42.1, 1.22')
            moon.antenna = antenna
            off1_azel = katpoint.construct_azel_target(wrap_angle(moon.azel()[0] + np.radians(10)),
                                                       moon.azel()[1])
