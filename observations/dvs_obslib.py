...
__d_tilt_OK__ = ["e121","e117","e119","e116","e115","e060","e020","e018","e107","e110","e118","e017"] # These tilt installations believed to be OK
...
def cycle_feedindexer(ants, cycle, switch_indexer_every_nth_cycle, dry_run=False, avoid_x=False):
    ...
    try: # Switch away from nominal position
        ...
        if (len(ants[2]) > 0): # SKA
            user_logger.info("Switching SKA Feed Indexer back to index %s"%index0[2])
            if not dry_run:
